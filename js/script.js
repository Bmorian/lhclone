...
function playInterval(){
  ...
  $('.ri-arrow-right-s-line').click(function(){
   ...
   // $('.ri-pause-line').click(function(e){           
   //     e.preventDefault();
   //     $('.ri-arrow-right-s-fill').hide();
   // });



    //$(function)
    //    $('.ri-pause-line').click.removeClass('.count');
    //    $(this).addClass('.ri-arrow-right-s-fill');
    

   // $('.tabcontent').hide();                //본문을 모두 안보이게 처리, faidOut()사용가능
   // const cityName = $(this).attr("href");  //클릭한 곳의 href 값을 가져옴
   // $(cityName).show();                     //href 값과 tabcontent의 id값이 일치하면 보이게 처리, faidIn()


    //$('.ri-arrow-right-s-fill').click.removeClass('.count');
    //$(this).addClass('.ri-pause-line'); 
